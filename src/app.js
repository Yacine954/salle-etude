function startApp() {
  ...
  function renderAnnalesList(list, groupByModule) {
            if (!list.length) return '<div class="notes-empty"><p>Aucun sujet pour l\'instant.</p><p>Les sujets sont ajoutés au fil de l\'année. Si tu as un sujet, un corrigé ou une photo d\'énoncé, envoie-le à <a href="mailto:yacineguett@gmail.com?subject=Salle%20d\'étude%20—%20sujet%20d\'examen">yacineguett@gmail.com</a> : il sera mis en ligne pour tout le monde.</p></div>';
