...
code: S10
priorite: 2
titre: Business English for finance
accroche: Le vocabulaire des états financiers, du crédit client et de la trésorerie, plus les emails de relance et la présentation orale en anglais.
couleur: 96
---
...
## Accounts receivable
Créances clients (on nous doit).

## Accounts payable
Dettes fournisseurs (nous devons).

## Aging report
Balance âgée : créances classées par tranche d'ancienneté (buckets).

## Overdue / past due
En retard de paiement (échéance dépassée).

## Outstanding
En cours, non encore réglé (échu ou non).

## Write-off
Passage en perte d'une créance irrécouvrable.
...
## Dunning
Processus de relance des impayés (reminders, final notice).

## Credit hold
Blocage des livraisons ou commandes d'un client en retard de paiement.

## Remittance advice
Avis de règlement envoyé par le client précisant les factures payées.

## Credit note
Avoir.

## DSO
Days sales outstanding : délai moyen de recouvrement.
...
## Covenant
Clause contractuelle d'un prêt (ratios à respecter).

## Hedging
Couverture d'un risque financier (change, taux).

## Due diligence
Audits préalables à une acquisition.

## Turnover / revenue
Chiffre d'affaires (UK / US).
...
## Objet d'un email de relance
```
Overdue invoice no. [X] – €[amount] – due [date]
```
> Précis, sans point d'exclamation.

## Reminder 1 (friendly)
```
According to our records, invoice no. X for €Y, due on [date], remains outstanding. Could you please confirm when we can expect payment?
```
> + « Please disregard this message if payment has already been made. »

## Reminder 2 (firm)
```
Despite our previous reminder, invoice no. X is now [N] days overdue. We kindly ask you to settle the outstanding balance of €Y by [date].
```
> + ouvrir la porte au litige : « Should there be any dispute… »

## Final notice
```
This is a final notice. Unless payment is received by [date], we will place your account on credit hold and refer the matter to our legal department.
```
> Citer les conditions générales.

## Nombres
```
1,250.50 → one thousand two hundred and fifty point five zero ; 2.4 million ; 1.2 billion (milliard)
```
> Point = décimales, virgule = milliers.

## Variations
```
up / down by X % ; X percentage points ; year-on-year (YoY) ; versus budget ; flat
```
> « By » pour l'ampleur, « to » pour le niveau atteint.

## Dates et délais
```
due on 15 June ; payable within 30 days ; by 31 July (au plus tard) ; net 30 ; 2/10 net 30
```
> UK : 15 June 2026 ; US : June 15, 2026.

## Structure d'un exposé
```
Today I'd like to cover three points → Let me start with → Moving on to → To sum up → I'd be happy to take your questions
```
> Une transition par slide.

## Pitch 60 secondes
```
Role → concrete result → current project → next step
```
> Quatre phrases, vocabulaire précis.

# Quiz

## « Accounts receivable » désigne :
- Les dettes fournisseurs
- [x] Les créances clients
...
## Les conditions « 2/10 net 30 » signifient :
- 2 % de pénalité après 10 jours
- [x] 2 % d'escompte si paiement sous 10 jours, sinon 30 jours
- Paiement en 2 fois
- 10 % d'acompte
> Escompte pour paiement anticipé, échéance normale à 30 jours.
...
## Traduire une balance âgée
Traduis en anglais : « Balance âgée au 31 août : encours total 610 k€, dont 400 k€ non échus, 120 k€ à 1-30 jours de retard, 60 k€ à 31-90 jours, 30 k€ à plus de 90 jours. Provision pour créances douteuses : 21 k€. »

> **Solution** : « Aged receivables as at 31 August: total outstanding €610k, of which €400k current, €120k 1-30 days past due, €60k 31-90 days past due and €30k over 90 days past due. Allowance for doubtful accounts: €21k. »

## Rédiger une deuxième relance
Rédige en anglais une relance ferme pour la facture 2026-204 de 12 800 €, échue le 10 juillet, aujourd'hui 40 jours de retard, avec une date limite au 5 septembre.

> **Solution** : Subject: Overdue invoice no. 2026-204 – €12,800.00 – due 10 July. « Dear Mr Smith, Despite our previous reminder, invoice no. 2026-204 for €12,800.00, due on 10 July, is now 40 days overdue. We kindly ask you to settle the outstanding balance by 5 September. Should there be any dispute regarding this invoice, please let us know as soon as possible so that we can resolve it. Please find attached a copy of the invoice. Thank you for your prompt attention to this matter. Kind regards, … »

## Lire des chiffres à l'oral
Écris en toutes lettres (anglais) : 3,475.20 € ; 12.5 % ; 2.3 billion ; une hausse du DSO de 52 à 58 jours.

> **Solution** : « Three thousand four hundred and seventy-five euros and twenty cents » ; « twelve point five percent » ; « two point three billion » ; « DSO rose by six days, from fifty-two to fifty-eight days » (ou « increased from 52 to 58 days »).
