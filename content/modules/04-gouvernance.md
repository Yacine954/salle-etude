...
code: S9
priorite: 2
titre: Gouvernance, RSE & communication financière
accroche: Théorie de l'agence, organes de gouvernance, finance durable (CSRD), obligations d'information et art du reporting.
couleur: 272
---
...
## Coûts d'agence
Coûts nés de la divergence d'intérêts entre actionnaires et dirigeants : surveillance, dédouanement, perte résiduelle.

## Asymétrie d'information
Situation où le dirigeant en sait plus que l'actionnaire sur l'entreprise ; source des problèmes d'agence.

## Administrateur indépendant
Membre du conseil sans lien de dépendance (salarié, client, fournisseur, actionnaire important) avec la société.

## Comité d'audit
Comité du conseil chargé du suivi de l'information financière, du contrôle interne, des risques et de l'indépendance des auditeurs.

## Say on pay
Vote des actionnaires en assemblée générale sur la politique et les éléments de rémunération des dirigeants.

## Comply or explain
Principe des codes de gouvernance : appliquer les recommandations ou expliquer pourquoi on s'en écarte.

## ESG
Environnement, social, gouvernance : les trois piliers d'évaluation extra-financière.

## CSRD / ESRS
Directive européenne sur le reporting de durabilité / standards de contenu de ce rapport.

## Double matérialité
Analyser à la fois l'impact de l'entreprise sur la société et l'environnement, et l'impact financier des enjeux de durabilité sur l'entreprise.

## Taxonomie européenne
Classification des activités économiques durables selon six objectifs environnementaux.

## Greenwashing
Communication donnant une image écologique trompeuse ; sanctionnable comme pratique commerciale trompeuse.

## Information réglementée
Ensemble des informations qu'une société cotée doit publier (périodiques et permanentes) sous contrôle de l'AMF.

## Information privilégiée
Information précise, non publique, susceptible d'influencer sensiblement le cours ; son usage constitue un abus de marché.

## Guidance
Objectifs chiffrés communiqués au marché par la direction (CA, marge, résultat).

## Profit warning
Avertissement sur résultats : annonce que les objectifs communiqués ne seront pas atteints.

## Devoir de vigilance
Obligation légale pour les grandes entreprises d'identifier et prévenir les atteintes aux droits humains et à l'environnement dans leur chaîne de valeur.

# Formules

## Coûts d'agence
```
Coûts d'agence = Coûts de surveillance + Coûts de dédouanement + Perte résiduelle
```
> Jensen & Meckling (1976).

## Mécanismes de gouvernance
```
Internes (conseil, comités, rémunération, say on pay) + Externes (marché du contrôle, analystes, notation, loi)
```
> Toujours citer les deux familles.

## Les trois piliers ESG
```
E (climat, ressources, pollution) · S (travail, diversité, chaîne d'approvisionnement) · G (éthique, transparence, indépendance)
```
> Notation extra-financière.

## Double matérialité
```
Matérialité d'impact (entreprise → monde) + Matérialité financière (monde → entreprise)
```
> Principe fondateur de la CSRD.

## Information privilégiée (3 critères)
```
Précise + Non publique + Susceptible d'influencer sensiblement le cours
```
> Les trois doivent être réunis.

## Structure d'un reporting
```
Contexte → Chiffres clés (3 à 5) → Écarts expliqués → Actions et décisions
```
> Vaut pour l'interne comme pour l'externe.

## Indicateurs recouvrement
```
DSO · Encours échu · Part > 90 j · Taux de recouvrement du mois · Nombre de litiges
```
...
## Une information est privilégiée si elle est :
- Publiée dans un communiqué
- [x] Précise, non publique et susceptible d'influencer le cours
- Connue uniquement des salariés
- Relative aux dividendes
> Les trois critères doivent être réunis ; l'utiliser est un abus de marché.

## Un « profit warning » est :
- Une hausse de dividende
- [x] Un avertissement que les objectifs annoncés ne seront pas atteints
- Un rapport du comité d'audit
- Une sanction de l'AMF
...
## Identifier un conflit d'agence
Un dirigeant propose une acquisition coûteuse qui doublerait la taille du groupe, avec une rentabilité attendue inférieure au coût du capital. Explique le conflit d'agence et deux mécanismes de gouvernance qui peuvent le limiter.

> **Solution** : Conflit : le dirigeant peut préférer la taille (prestige, rémunération liée au CA) à la création de valeur pour l'actionnaire. Mécanismes : (1) conseil avec administrateurs indépendants et comité stratégique qui challenge le projet ; (2) rémunération variable indexée sur la création de valeur (TSR, ROCE) plutôt que sur la taille ; on peut ajouter le marché du contrôle et l'activisme.

## Qualifier une information
Le directeur financier apprend que le premier client du groupe (20 % du CA) va résilier son contrat. Rien n'est public. Son ami lui demande s'il doit vendre ses actions. Que doit-il faire ?

> **Solution** : L'information est précise, non publique et de nature à influencer le cours : elle est privilégiée. Le DAF ne doit ni la transmettre ni conseiller (délit d'initié par communication/recommandation). La société doit la publier dès que possible (information permanente), sauf différé légitime et confidentialité assurée.

## Rédiger un reporting mensuel
Rédige en 5 lignes le reporting recouvrement du mois : DSO 52 jours (objectif 50, mois précédent 56), encours échu 1,2 M€ dont 300 k€ > 90 jours concentrés sur 2 clients, 4 nouveaux litiges.

> **Solution** : Contexte : périmètre clients France, mois M. Chiffres : DSO 52 j (−4 j vs M−1, +2 j vs objectif) ; encours échu 1,2 M€ ; > 90 j : 300 k€ sur 2 clients ; 4 litiges ouverts. Écarts : l'objectif n'est pas atteint à cause des 2 dossiers > 90 j (sans eux, DSO ≈ 49 j). Actions : mise en demeure proposée sur les 2 dossiers (décision attendue), résolution des 4 litiges avec le service commercial sous 15 jours, maintien de la priorisation TOP 15.
